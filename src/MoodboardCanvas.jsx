...
const colorGenerate = (dan, ene, val, aco, tem, bw = 0) => {
    ...
    if(text_flag == 0) var TX = tinycolor("hsv(" + (hue + rand_flag * 10 + 360) % 360 + "," + 0.9 + "," + 0.2 + ")");
    else var TX = tinycolor("hsv(" + (hue + rand_flag * 10 + 360) % 360 + "," + 0.05 + "," + 0.95 + ")");
    if(graph_flag == 0){
        var sat2 = sat - 0.05;
        if(sat2 < 0) sat2 = 0;
        var bri2 = bri + 0.1;
